...
include('../dist/includes/dbcon.php');
	...
	$query2=mysqli_query($con,"select * from clientes where ruc='$ruc'")or die(mysqli_error($con));
		...
		else
		{
			...
			mysqli_query($con,"INSERT INTO clientes(nombre,ruc,telefono,dni,nombre_mascota,raza)
				VALUES('$nombre','$ruc','$telefono','$dni','$nombre_mascota','$raza')")or die(mysqli_error($con));
