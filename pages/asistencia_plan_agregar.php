...
?>
  ...
  <div class = "row">
        <div class = "col-md-4 col-lg-12 hide-section">
            <a class="btn btn-danger btn-print"    disabled="true" style="height:25%; width:50%; font-size: 25px " role="button">MEMBRESIA DE:  <label style='color:black;  font-size: 25px '><?php echo $nombre_cliente;?></label></a>

  <a class="btn btn-danger btn-print"    disabled="true" style="height:25%; width:50%; font-size: 25px " role="button">Fecha inicio= <label style='color:black;  font-size: 25px '>=<?php echo $fecha_inicio;?></label></a>
  <a class="btn btn-danger btn-print"    disabled="true" style="height:25%; width:50%; font-size: 25px " role="button">Fecha fin= <label style='color:black;  font-size: 25px '>=<?php echo $fecha_fin;?></label></a>
