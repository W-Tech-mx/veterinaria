...
<?php
            ...
            $query3=mysqli_query($con,"select * from historial where  codigo='$codigo' ")or die(mysqli_error());
                   ...
                   <div class="row">
                    <div class="col-md-3 btn-print">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control pull-right" id="descripcion" name="descripcion" value="<?php echo $descripcion;?>" required >
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
