   ...
   <li><a href = "caja.php"><i class="fa fa-bank"></i> Caja <span class="fa fa-chevron-right"></span></a></li>
                 ...
                 <li><a><i class="fa fa-group"></i> Usuarios<span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a href="cliente.php">Mascota /Cliente</a></li>
      ...
      <li><a href="cliente_historial.php">Historial</a></li>
          ...
          <?php
                      ...
                      ?>
                              ...
                              <li><a href = "cliente_historial.php"><i class="fa fa-retweet"></i>Historial<span class="fa fa-chevron-right"></span></li></a>
     ...
     if ($tipo=="administrador") {
       ...
       <li><a href = "ganancias_anio.php"><i class="fa fa-line-chart"></i>Ganancios del año<span class="fa fa-chevron-right"></span></li></a>
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a href="ventas_servicios.php">Ventas Servicios</a></li> 
                    ...
                    <ul class="nav child_menu">
                      ...
                      <li><a href="ventas_servicios_totales.php">Servicios</a></li>
                 ...
                 <li><a><i class="fa fa-bar-chart"></i> Reportes Ventas servicios<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="reportes_por_fecha_servicios.php">Entre fechas</a></li>
                      <li><a href="reportes_por_dia_servicios.php">Por dia</a></li> 
                     <li><a href="reportes_por_mes_servicios.php">Por mes</a></li> 
      <li><a href="reportes_ultimos_7dias_servicios.php">Ultimos 7 dias</a></li> 
                    </ul>
                  </li>
